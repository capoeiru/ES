...
foreach ($a as $key => $value) {
    if("" != trim($_POST[$key])){    
        ...
        echo json_encode("Missing parameter '" . $key . "'");
        die;
}
};
...
if (strcmp(strtolower($a["gender"]), "male") == 0) {
	$sex = 0;
} elseif (strcmp(strtolower($a["gender"]), "female") == 0) {
	$sex = 1;
}
